...
<script type="application/json" id="rankproof-auth-popup-msg">${payload}</script>
<script>
(function () {
  var el = document.getElementById("rankproof-auth-popup-msg");
  var msg = { source: "rankproof-auth-popup", token: null };
